...
const topItems = [
  {
    title: "Layers Panel",
    description:
      "Index, translate, and manage every text layer from a single spreadsheet interface — with built-in AI translation, TSV export, and one-click generation.",
    images: [
      {
        src: "/images/ae-sheets/features/layer-card.png",
        alt: "Layers Panel interface",
        width: 495,
        height: 186,
      },
    ],
  ...
  },
  {
    title: "Presets",
    description:
      "Save per-language font, size, and RTL settings as reusable presets to localize across projects without re-configuring.",
    images: [
      {
        src: "/images/ae-sheets/features/presets-card.png",
        alt: "Preset Panel interface",
        width: 350,
        height: 186,
      },
    ],
...
const bottomItems = [
  {
    ...
    images: [
      {
        src: "/images/ae-sheets/features/rigging-tools.png",
        alt: "Rigging Tools interface",
        width: 405,
        height: 295,
      },
    ],
...
export const AESheetsFeatures = () => {
  return (
    <section id="ae-sheets-features" className="overflow-hidden py-28 lg:py-32">
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          Everything you need to manage your spreadsheets in AE
        </h2>
...
const Item = ({ item, isLast, className }: ItemProps) => {
  return (
    <div
      className={cn(
        "relative flex flex-col justify-center px-0 py-6 md:px-6 md:py-8",
        className,
        item.className,
      )}
    >
