...
export function VideoPlayer({ src, poster, className }: VideoPlayerProps) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 translate-y-2 bg-gradient-to-t from-black/35 to-transparent px-4 pt-10 pb-3 opacity-0 transition duration-150 ease-in will-change-transform group-hover/video:pointer-events-auto group-hover/video:translate-y-0 group-hover/video:opacity-100 group-hover/video:duration-200 group-hover/video:ease-out">
        <div className="flex items-center gap-0.5">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 px-2">
            <span className="pointer-events-none tabular-nums text-xs font-semibold text-white">
