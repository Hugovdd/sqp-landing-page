    ...
    <article className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-primary">{article.category.name}</span>
                <div className="flex flex-col gap-1">
                    <a
                        href={article.href}
                        className="group/title flex justify-between gap-x-4 rounded-md text-lg font-semibold text-foreground outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
                    >
                        {article.title}
                        <ArrowUpRight
                            className="mt-0.5 size-6 shrink-0 text-muted-foreground transition duration-100 ease-linear group-hover/title:text-foreground"
                            aria-hidden="true"
                        />
                    </a>

                    <p className="line-clamp-2 text-base text-muted-foreground">{article.summary}</p>
                </div>
            </div>
            ...
            <div className="flex gap-2">
                ...
                <div>
                    <a
                        ...
                        className="block rounded-sm text-sm font-semibold text-foreground outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
                    >
                        {article.author.name}
                    </a>
